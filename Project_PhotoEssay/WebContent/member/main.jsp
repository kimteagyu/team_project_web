  ...
  <header class="header cfixed">
    <div class="Wrap">
      ...
      <div>
		...
		<img src="image/photo_Essay.png" style="float: left; width: 100px; height: 100px;" /></h1>
			</div>
			<br>
			<br>
		  <div>
    ...
    <div class="sidebar" style="flex:0.3">
      ...
      <ul class="nav_list">
        ...
        <li>
          ...
          <a href="Index.jsp" <i class='bx bx-home'></i>
	  ...
	  <li>
		...
		<li>
            ...
            <a href="Index.jsp">
			<span class="index.jsp" style="color:aqua">Logout</a> 
