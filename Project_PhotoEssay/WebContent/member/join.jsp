...
<!--<hr class="divider">-->
  ...
  <div id="content">
      ...
      <br>
	  <br>
	<h2 text style="color: gray">회원 가입</h2>
<td>'*' 필수 입력 사항</td>
<form action="join.do" method="post" name="frm">
	<table>
		<tr>
			<th text style="color: blue">이름</th>
			<td><input type="text" name="name" size="20">*</td>
		</tr>
		<tr>
			<th text style="color:green">아이디</th>
			<td><input type="text" name="userid" size="20">*
			    <input type="button" value="중복체크" onclick="idCheck()">
			    </td>
		</tr>
		<tr>
			<th text style="color:darkred">비밀번호</th>
			<td><input type="password" name="pwd" size="20">*</td>
		</tr>
		
		<tr>
			<th text style="color:hotpink">닉네임</th>
		...
		<tr>
			<th text style="color:orange">이메일</th>
